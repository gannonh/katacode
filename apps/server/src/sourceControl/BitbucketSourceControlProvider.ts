...
import { SourceControlProviderError, type ChangeRequest } from "@kata-sh/code-contracts";
...
export const makeDiscovery = Effect.fn("makeBitbucketSourceControlProviderDiscovery")(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set KATACODE_BITBUCKET_EMAIL and KATACODE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
