...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@kata-sh/code-contracts";
import { VcsUnsupportedOperationError } from "@kata-sh/code-contracts";
...
export class VcsDriverRegistry extends Context.Service<VcsDriverRegistry, VcsDriverRegistryShape>()(
  "@kata-sh/code-cli/vcs/VcsDriverRegistry",
) {}
