...
export const PERSISTED_STATE_KEY = "katacode:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "katacode:renderer-state:v8",
  "katacode:renderer-state:v7",
  "katacode:renderer-state:v6",
  "katacode:renderer-state:v5",
  "katacode:renderer-state:v4",
  "katacode:renderer-state:v3",
