...
const PIERRE_ICON_SPRITE_ID = "katacode-pierre-file-icon-sprite";

const KATACODE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="katacode-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="katacode-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="katacode-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="katacode-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="katacode-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="katacode-file-icon-pnpm" viewBox="0 0 32 32">
...
export const KATACODE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: KATACODE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "katacode-file-icon-package-json",
    "tsconfig.json": "katacode-file-icon-tsconfig",
    "agents.md": "katacode-file-icon-agents",
    "claude.md": "katacode-file-icon-claude",
    "readme.md": "katacode-file-icon-readme",
    "pnpm-lock.yaml": "katacode-file-icon-pnpm",
    "pnpm-workspace.yaml": "katacode-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(KATACODE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${KATACODE_FILE_ICON_SPRITE}`;
