...
export const CLIENT_SETTINGS_STORAGE_KEY = "katacode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "katacode:saved-environment-registry:v1";
