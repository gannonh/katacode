...
>()("@kata-sh/code-desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__KATACODE_ENV_${name}_START__`;
const endMarker = (name: string) => `__KATACODE_ENV_${name}_END__`;
