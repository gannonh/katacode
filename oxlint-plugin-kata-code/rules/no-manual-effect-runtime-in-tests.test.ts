...
const rule = createOxlintRuleHarness("kata-code/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("kata-code/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("kata-code/no-manual-effect-runtime-in-tests");
