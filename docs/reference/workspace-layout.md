...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@kata-sh/code-shared/git`, `@kata-sh/code-shared/DrainableWorker`) — no barrel index.
