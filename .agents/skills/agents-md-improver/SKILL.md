...
**Note:** Agents auto-discovers AGENTS.md files in parent directories, making monorepo setups work automatically.
...
| Architecture clarity          | High   | Can Agents understand the codebase structure? |
...
- **`#` key shortcut**: During an Agent session, press `#` to have Agent auto-incorporate learnings into AGENTS.md
